...
const enforce = require('express-sslify'); // 为PWA配置: 强制https,因heroku没有强制https选项( 完成笔记 )
...
app.use( enforce.HTTPS({ trustProtoHeader: true }) ); // 信任协议标头变为true,就是在heroku中强制https开启( 完成笔记 )
...
// 配置PWA: node配置service-worker.js( 完成笔记 )
