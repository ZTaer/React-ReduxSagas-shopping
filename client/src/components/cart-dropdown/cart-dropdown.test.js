...
describe( '购物车下拉菜单',()=>{
    ...
    it(" 测试单击下拉菜单按钮 ",()=>{
        ...
        expect(mockHistory.push).toHaveBeenCalled(); // toHaveBeenCalled: 确保某个函数功能调用( 等待笔记 )
    ...
    it(" 验证当购物车为空时的提示 ",()=>{
        ...
        expect( newWrapper.exists("CartItemsAlt") ).toBe(true);  // exists(): 验证指定组件是否存在( 等待笔记 )
    });
